--------------------------------------------------------
--  Datei erstellt -Sonntag-Juni-30-2019   
--------------------------------------------------------
...
DROP TABLE "COMPANY"."T_LEX_SICH1" cascade constraints;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."IMP_BA_BEL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2521 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."INP_BELEGE_ALL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1581 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."INP_BELEGE_ALL_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence INP_BELEGE_POS_ALL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."INP_BELEGE_POS_ALL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 281 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."KTO_Girokonto_SEQ7"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence KTO_Girokonto_SEQ8
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."KTO_Girokonto_SEQ8"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."KTO_KONTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2461 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."SEQ_ADRESSE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 601 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."SEQ_LOCATION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 621 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."SEQ_ORT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 461 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."SEQ_PLZ_ORT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 424 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_ABL_ORDNER_PAGE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_GESCHAEFTSPARTNER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_KONTO_AUSZUG_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 241 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence T_KONTO_BUCH_KAT_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."T_KONTO_BUCH_KAT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 334 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_LEX_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2431 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence T_LOCATION_TYPE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."T_LOCATION_TYPE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 181 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_PROJEKT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 201 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_REL_BEL_KONT_BUCH_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2841 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence T_REL_BEL_LEX_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."T_REL_BEL_LEX_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3261 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "COMPANY"."T_REL_KONTO_AUSZUG_GIR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 3221 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence T_REL_LEX_KTO_BEL_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "COMPANY"."T_REL_LEX_KTO_BEL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6741 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USER01" ;
--------------------------------------------------------
--  DDL for Table T_LEX_SICH1
--------------------------------------------------------

  CREATE TABLE "COMPANY"."T_LEX_SICH1" 
   (	"BELEGDATUM" VARCHAR2(26 BYTE), 
	"BUCHUNGSDATUM" VARCHAR2(26 BYTE), 
	"BUCHUNGSPERIODE" NUMBER(3,0), 
	"BELEGNUMMERNKREIS" VARCHAR2(26 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "COMPANY"."T_REL_LEX_KTO" 
   (	"FK_MAIN_KEY" NUMBER, 
	...
	"Betrag" BINARY_DOUBLE, 
	"Währung" VARCHAR2(255 BYTE), 
	"Fremdwährungsbetrag" BINARY_DOUBLE, 
	"Fremdwährung" VARCHAR2(255 BYTE), 
	"BUCHUNGSTEXT" VARCHAR2(4000 BYTE), 
	"FK_Kategorie" NUMBER, 
	"FK_Verwendungszweck" NUMBER, 
	...
	"FK_BUCHUNG_STEUER" NUMBER, 
	"FK_MAIN_KEY_SUB" NUMBER, 
	"BUCHUNGSTAG_SUB" DATE, 
	"BUCHUNGSTEXT_SUB" VARCHAR2(4000 BYTE), 
	"KONTOTYP_SUB" VARCHAR2(255 BYTE), 
	"CNT_FK_INP_BELEGE_ALL" NUMBER, 
	"SUM_STATUS" NUMBER, 
	"SUM_STATUS_S1" NUMBER, 
	"SUM_STATUS_S0" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "COMPANY"."V_LEX_BUCH_KTO_NEU" ("BELEGDATUM", "BUCHUNGSDATUM", "BUCHUNGSPERIODE", "BELEGNUMMERNKREIS", "BELEGNUMMER", "BUCHTEXT", "BUCHUNGSBETRAG", "SOLLKONTO", "HABENKONTO", "STEUERSCHLÜSSEL", "KOSTENSTELLE", "KOSTENTRÄGER", "BUCHUNGSBETRAG_EURO", "WÄHRUNG", "ZUSATZANGABEN", "OK", "FK_MAIN_KEY", "ID", "Buchungstag", "Betrag", "Währung", "Fremdwährungsbetrag", "Fremdwährung", "BUCHUNGSTEXT", "FK_Kategorie", "FK_Verwendungszweck", "FK_Kontotyp", "FK_BUCHUNGSTAG", "FK_WERTSTELLUNG", "VERWENDUNGSZWECK", "KATEGORIE", "BUCHT_TAG", "BUCHT_MONAT", "BUCHT_JAHR", "BUCHT_DATUM", "WERTT_TAG", "WERTT_MONAT", "WERTT_JAHR", "WERTT_DATUM", "Kontotyp", "FK_VORGANG", "WIEDERHOLUNG", "NAECHSTE_ZAHLUNG", "FK_BUCHUNG_STEUER", "STORNO", "PK_LEX", "BEMERKUNGEN", "FK_IMP_BA_BEL", "WERT", "SEL_OK", "MWST_PROZ", "PK_INVENTAR", "INVENTAR", "PK_PROJEKT", "PROJEKT", "DIFF", "BEZEICHNUNG", "SUM_BETRAG") AS 
  select distinct

       lex_kto."BELEGDATUM",lex_kto."BUCHUNGSDATUM",lex_kto."BUCHUNGSPERIODE",lex_kto."BELEGNUMMERNKREIS",lex_kto."BELEGNUMMER",lex_kto."BUCHTEXT",lex_kto."BUCHUNGSBETRAG",lex_kto."SOLLKONTO",lex_kto."HABENKONTO",lex_kto."STEUERSCHLÜSSEL",lex_kto."KOSTENSTELLE",lex_kto."KOSTENTRÄGER",lex_kto."BUCHUNGSBETRAG_EURO",lex_kto."WÄHRUNG",lex_kto."ZUSATZANGABEN",lex_kto."OK",lex_kto."FK_MAIN_KEY",lex_kto."ID",lex_kto."Buchungstag",lex_kto."Betrag",lex_kto."Währung",lex_kto."Fremdwährungsbetrag",lex_kto."Fremdwährung",lex_kto."BUCHUNGSTEXT",lex_kto."FK_Kategorie",lex_kto."FK_Verwendungszweck",lex_kto."FK_Kontotyp",lex_kto."FK_BUCHUNGSTAG",lex_kto."FK_WERTSTELLUNG",lex_kto."VERWENDUNGSZWECK",lex_kto."KATEGORIE",lex_kto."BUCHT_TAG",lex_kto."BUCHT_MONAT",lex_kto."BUCHT_JAHR",lex_kto."BUCHT_DATUM",lex_kto."WERTT_TAG",lex_kto."WERTT_MONAT",lex_kto."WERTT_JAHR",lex_kto."WERTT_DATUM",lex_kto."Kontotyp",lex_kto."FK_VORGANG",lex_kto."WIEDERHOLUNG",lex_kto."NAECHSTE_ZAHLUNG",lex_kto."FK_BUCHUNG_STEUER",lex_kto."STORNO",lex_kto."PK_LEX",lex_kto."BEMERKUNGEN",lex_kto."FK_IMP_BA_BEL",
       round(lex_kto."Betrag",2) wert,
       apex_item.checkbox2(1, pk_lex,'CHECKED') sel_ok,
       case when    "STEUERSCHLÜSSEL" = 8 then '7' 
            when    "STEUERSCHLÜSSEL" = 9 then '19'
            else null
       end mwst_proz,
       inv.pk_inventar,
       inv.inventar,
  ...
  from 
       ...
       lex.fk_imp_ba_bel 
         from T_LEX lex
          full  join v_konten_zus kto on kto.fk_main_key= lex.fk_main_key) lex_kto
        left join t_rel_inventar_zahlung invzahl on lex_kto.fk_main_key = invzahl.fk_main_key
        left join t_inventare inv on inv.pk_inventar = invzahl.fk_inventar
        left join t_rel_projekt_zahlung przahl on przahl.fk_main_key =lex_kto.fk_main_key
        left join t_projekt pr on pr.pk_projekt = przahl.fk_projekt
        left join t_kontenplan_konten konten on konten.konten_nr_ext = lex_kto.sollkonto
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "COMPANY"."V_REL_LEX_KTO" ("FK_MAIN_KEY", "ID", "Buchungstag", "Betrag", "Währung", "Fremdwährungsbetrag", "Fremdwährung", "BUCHUNGSTEXT", "FK_Kategorie", "FK_Verwendungszweck", "FK_Kontotyp", "FK_BUCHUNGSTAG", "FK_WERTSTELLUNG", "VERWENDUNGSZWECK", "KATEGORIE", "BUCHT_TAG", "BUCHT_MONAT", "BUCHT_JAHR", "BUCHT_DATUM", "WERTT_TAG", "WERTT_MONAT", "WERTT_JAHR", "WERTT_DATUM", "Kontotyp", "FK_VORGANG", "WIEDERHOLUNG", "NAECHSTE_ZAHLUNG", "FK_BUCHUNG_STEUER", "FK_MAIN_KEY_SUB", "BUCHUNGSTAG_SUB", "BUCHUNGSTEXT_SUB", "KONTOTYP_SUB") AS 
  select kto_zus_Main."FK_MAIN_KEY",kto_zus_Main."ID",kto_zus_Main."Buchungstag",kto_zus_Main."Betrag",kto_zus_Main."Währung",kto_zus_Main."Fremdwährungsbetrag",kto_zus_Main."Fremdwährung",kto_zus_Main."BUCHUNGSTEXT",kto_zus_Main."FK_Kategorie",kto_zus_Main."FK_Verwendungszweck",kto_zus_Main."FK_Kontotyp",kto_zus_Main."FK_BUCHUNGSTAG",kto_zus_Main."FK_WERTSTELLUNG",kto_zus_Main."VERWENDUNGSZWECK",kto_zus_Main."KATEGORIE",kto_zus_Main."BUCHT_TAG",kto_zus_Main."BUCHT_MONAT",kto_zus_Main."BUCHT_JAHR",kto_zus_Main."BUCHT_DATUM",kto_zus_Main."WERTT_TAG",kto_zus_Main."WERTT_MONAT",kto_zus_Main."WERTT_JAHR",kto_zus_Main."WERTT_DATUM",kto_zus_Main."Kontotyp",kto_zus_Main."FK_VORGANG",kto_zus_Main."WIEDERHOLUNG",kto_zus_Main."NAECHSTE_ZAHLUNG",kto_zus_Main."FK_BUCHUNG_STEUER",  kto_zus_sub.fk_main_key fk_main_key_sub, kto_zus_sub."Buchungstag" Buchungstag_sub, kto_zus_sub.Buchungstext buchungstext_sub, kto_zus_sub."Kontotyp" kontotyp_sub
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "COMPANY"."V_REL_LEX_KTO_BEL" ("FK_MAIN_KEY", "FK_INP_BELEGE_ALL", "CNT_FK_RELATION") AS 
  select distinct  fk_main_key, fk_inp_belege_all, sum(case when fk_relation is null then 0 else 1 end) over (partition by  fk_main_key, fk_inp_belege_all) cnt_fk_relation 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "COMPANY"."V_REL_LEX_REL_BEL" ("FK_RELATION", "FK_INP_BELEGE_ALL", "CNT_FK_MAIN_KEY") AS 
  select distinct fk_relation, fk_inp_belege_all, sum(case when fk_main_key is null then 0 else 1 end) over (partition by  fk_relation, fk_inp_belege_all) cnt_fk_main_key 
from t_rel_lex_kto_bel
;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "COMPANY"."V_REL_LEX_REL_KTO" ("FK_RELATION", "FK_MAIN_KEY", "CNT_INP_BELEGE_ALL", "BELEGDAT", "ABSCHLUSS", "BELEG", "BENUTZER", "BETRAGDM", "BETRAGEUR", "BUCHDAT", "NR", "HABENDM", "HABENEUR", "HABEN", "JOUR_DAT", "RELATION", "SOLLDM", "SOLLEUR", "SOLL", "SPERRE", "STAPEL", "STATUS", "STATUS_DAT", "UST_H_DM", "UST_H_EUR", "UST_HABEN", "UST_S_DM", "UST_S_EUR", "UST_SOLL", "UST_DM", "UST_EUR", "UST", "UST_KTO", "UST_KTO_H", "UST_KTO_S", "UST_PROZ", "UST_TEXT", "PERIODE", "BELEGNR", "BUCHUNGSTEXT", "BETRAG", "WHRG", "SOLLKTO", "HABENKTO", "ZUSATZANG", "NOTIZ", "KST", "KTR", "JAHR", "JAHR_BELEG", "STATUS_S1", "STATUS_S0") AS 
  select distinct kto_bel.fk_relation,
             kto_bel.fk_main_key, 
             sum(case when fk_inp_belege_all is null then 0 else 1 end) over (partition by  kto_bel.fk_relation, kto_bel.fk_main_key) cnt_inp_belege_all , 
             lexl."BELEGDAT",lexl."ABSCHLUSS",lexl."BELEG",lexl."BENUTZER",lexl."BETRAGDM",lexl."BETRAGEUR",lexl."BUCHDAT",lexl."NR",lexl."HABENDM",lexl."HABENEUR",lexl."HABEN",lexl."JOUR_DAT",lexl."RELATION",lexl."SOLLDM",lexl."SOLLEUR",lexl."SOLL",lexl."SPERRE",lexl."STAPEL",lexl."STATUS",lexl."STATUS_DAT",lexl."UST_H_DM",lexl."UST_H_EUR",lexl."UST_HABEN",lexl."UST_S_DM",lexl."UST_S_EUR",lexl."UST_SOLL",lexl."UST_DM",lexl."UST_EUR",lexl."UST",lexl."UST_KTO",lexl."UST_KTO_H",lexl."UST_KTO_S",lexl."UST_PROZ",lexl."UST_TEXT",lexl."PERIODE",lexl."BELEGNR",lexl."BUCHUNGSTEXT",lexl."BETRAG",lexl."WHRG",lexl."SOLLKTO",lexl."HABENKTO",lexl."ZUSATZANG",lexl."NOTIZ",lexl."KST",lexl."KTR",lexl."JAHR",lexl."JAHR_BELEG",
            -- kto_zus.*,
           case when status is not null then 1 else 0 end status_s1, 
              case when status is null  and fk_relation is not null then 1 else 0 end status_s0
from t_rel_lex_kto_bel kto_bel
        left join t_lex_long lexl on kto_bel.fk_relation = lexl.relation
...
--------------------------------------------------------
--  DDL for Trigger INP_BELEGE_ALL_TRG17
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."INP_BELEGE_ALL_TRG17" 
BEFORE INSERT ON INP_BELEGE_ALL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "COMPANY"."INP_BELEGE_ALL_TRG17" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger T_LEX_TRG4
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_LEX_TRG4" 
BEFORE INSERT ON T_LEX 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "COMPANY"."T_LEX_TRG4" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger T_REL_BEL_KONT_BUCH_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_BEL_KONT_BUCH_TRG" 
BEFORE INSERT ON T_REL_BEL_KONT_BUCH 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_REL_BEL_KONT_BUCH IS NULL THEN
      SELECT T_REL_BEL_KONT_BUCH_SEQ.NEXTVAL INTO :NEW.PK_REL_BEL_KONT_BUCH FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "COMPANY"."T_REL_BEL_KONT_BUCH_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_REL_BEL_LEX_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_BEL_LEX_TRG" 
BEFORE INSERT ON T_REL_BEL_LEX 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
...
END;
/
ALTER TRIGGER "COMPANY"."T_REL_BEL_LEX_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_REL_BEL_LEX_TRG1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_BEL_LEX_TRG1" 
BEFORE INSERT ON T_REL_BEL_LEX 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.PK_REL_BEL_LEX IS NULL THEN
      SELECT T_REL_BEL_LEX_SEQ.NEXTVAL INTO :NEW.PK_REL_BEL_LEX FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "COMPANY"."T_REL_BEL_LEX_TRG1" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_LEX_KTO_BEL_TRG" 
...
--------------------------------------------------------
--  DDL for Trigger T_REL_LEX_KTO_BEL_TRG1
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_LEX_KTO_BEL_TRG1" 
BEFORE INSERT ON T_REL_LEX_KTO_BEL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "COMPANY"."T_REL_LEX_KTO_BEL_TRG1" ENABLE;
--------------------------------------------------------
--  DDL for Trigger T_REL_LEX_KTO_BEL_TRG2
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "COMPANY"."T_REL_LEX_KTO_BEL_TRG2" 
BEFORE INSERT ON T_REL_LEX_KTO_BEL 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
END;
/
ALTER TRIGGER "COMPANY"."T_REL_LEX_KTO_BEL_TRG2" ENABLE;
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE "COMPANY"."P_INP_BEL_COP" (bel_nr number, p_i number) AS
...
--------------------------------------------------------
--  Constraints for Table T_LEX_SICH1
--------------------------------------------------------

  ALTER TABLE "COMPANY"."T_LEX_SICH1" MODIFY ("PK_LEX" NOT NULL ENABLE);
--------------------------------------------------------
